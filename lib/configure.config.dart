...
import 'package:audio_player_package/bloc/audio_player_config_bloc.dart'
as _i946;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.singleton<_i1047.SliderSeekBloc>(
          () => _i1047.SliderSeekBloc(gh<_i632.AudioManager>()),
    );
    ...
    gh.singleton<_i946.AudioPlayerConfigBloc>(
          () => _i946.AudioPlayerConfigBloc(),
    );
    return this;
  }
}
