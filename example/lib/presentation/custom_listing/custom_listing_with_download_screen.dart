...
class CustomListingWithDownloadScreen extends StatelessWidget {
  static String path = "/custom-listing-with-download";

  const CustomListingWithDownloadScreen({super.key});
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return AudioItemView(
                        ...
                        audioContentList: album,
                        audioContent: audioContent,
                        isFromDownloadTile: true,
                      );
                    }),
              ),
            ],
